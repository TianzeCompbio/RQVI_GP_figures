"""
GP108 vs F11: UMAP cell-loading maps + MD gene-effect plots.

2x2 layout: top row = UMAP (RQVI GP108, Flashier F11),
            bottom row = MD (RQVI GP108, Flashier F11).
"""
...
# ─── Config ───────────────────────────────────────────────────────────────────
PAIR = {"rqvi_gp": 108, "flashier_factor": 11}
...
fig.suptitle("GP108 vs F11", fontsize=12, fontweight="bold", y=1.02)
fig.tight_layout()

# ─── Save ─────────────────────────────────────────────────────────────────────
outpath = FIG_DIR / "panel_gp108_detail.pdf"
