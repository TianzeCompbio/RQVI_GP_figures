"""
GP 45 vs Flashier F35 (r=0.436, below threshold): standalone 2×2 pair figure.

Top row: UMAP cell loadings (RQVI GP45, Flashier F35)
Bottom row: MD gene-effect plots (RQVI GP45, Flashier F35)
"""
