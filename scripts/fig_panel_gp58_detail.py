"""
GP58 vs F54: UMAP cell-loading maps + MD gene-effect plots.

2x2 layout: top row = UMAP (RQVI GP58, Flashier F54),
            bottom row = MD (RQVI GP58, Flashier F54).
"""
...
# ─── Config ───────────────────────────────────────────────────────────────────
PAIR = {"rqvi_gp": 58, "flashier_factor": 54}
...
fig.suptitle("GP58 vs F54", fontsize=12, fontweight="bold", y=1.02)
fig.tight_layout()

# ─── Save ─────────────────────────────────────────────────────────────────────
outpath = FIG_DIR / "panel_gp58_detail.pdf"
